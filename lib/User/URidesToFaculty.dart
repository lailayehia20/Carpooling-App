...
class UserToFaculty extends StatefulWidget {
  UserToFaculty({Key? key}) : super(key: key);

  @override
  State<UserToFaculty> createState() => _UserToFacultyState();
}

class _UserToFacultyState extends State<UserToFaculty> {
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text('Checkpoint: ${data['pickup_checkpoint']}', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                                  ...
                                  ElevatedButton(
                                    ...
                                    onPressed: () async {
                                        ...
                                        Ride ride = Ride(
                                          ...
                                          fare: data['price'],
                                          meetingPoint: data['pickup_checkpoint'],
                                          date: data['date'],
                                          time: data['time'],
